...
class Client:
	...
	def exitClient(self):
		...
		self.master.destroy() 
		os.remove("cache-{self.sessionId}.jpg") 
	...
	def writeFrame(self, data):
		...
		cachename = "cache-{self.sessionId}.jpg"
	...
	def handler(self):
		...
		self.pauseMovie()
		if tkMessageBox.askokcancel("Exit movie", "Are you sure you want to quit watching movies?"):
			self.exitClient()
		else: 
			self.playMovie()
